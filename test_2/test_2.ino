...
unsigned long millisSendLocation = 0;
...
void guiViTri(String phoneNumber)
{
    ...
    if (newData)
    {
        ...
        // Serial.println(millisSendLocation);
        // if (unsigned long (millis() - millisSendLocation) >= 3000)
        // {
        //   guiTinNhan(text, phoneNumber);
        // }
        // millisSendLocation = millis();
        // Serial.println(millisSendLocation)
        // if(unsigned long (millis() - millisSendLocation)
    }
    //-----------------------------------------------------------------
}
